...
- [Test Execution Pitfalls](../testing/TEST_EXECUTION_PITFALLS.md) — general CI / Playwright traps
- [Content format: Markdown vs plain text](../product/CONTENT_FORMAT_MARKDOWN_AND_PLAIN_TEXT.md) — touches `Notifications.vue` for rich text bodies
