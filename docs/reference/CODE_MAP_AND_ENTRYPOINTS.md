...
| [`api/schema_defs/`](../../apps/backend/courseeval_backend/api/schema_defs/) | Domain-grouped API schema definitions currently holding appearance, attendance, operations/settings, and points DTOs |
