...
| Validation target choice and evidence | [`../testing/DEVELOPMENT_AND_TESTING.md`](../testing/DEVELOPMENT_AND_TESTING.md) | [`../../skills/validation-selection/SKILL.md`](../../skills/validation-selection/SKILL.md) / [`../../skills/validation-ledger-maintenance/SKILL.md`](../../skills/validation-ledger-maintenance/SKILL.md) | `static.validation_selector` |
