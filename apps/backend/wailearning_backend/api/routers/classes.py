...
from apps.backend.wailearning_backend.db.models import Class, Student, Subject, User, UserRole
from apps.backend.wailearning_backend.api.schemas import ClassCreate, ClassResponse, ClassUpdate
