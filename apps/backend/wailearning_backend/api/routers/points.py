...
from apps.backend.wailearning_backend.db.models import User, Student, Class, PointRule, StudentPoint, PointRecord, PointItem, PointExchange, UserRole
...
from apps.backend.wailearning_backend.core.permissions import can_manage_students, is_admin
