...
Used by apps.backend.wailearning_backend.llm_grading to pick endpoints without calling the network; actual HTTP is in _request_grade_from_endpoint.
"""
...
class _GroupState:
    ...
    def _should_move_to_end(exc: Exception) -> bool:
        # Avoid importing apps.backend.wailearning_backend.llm_grading (circular); match by class name.
